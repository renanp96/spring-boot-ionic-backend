...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "renanp180@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,
				pe.encode("batata"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "9383893"));

		Cliente cli2 = new Cliente(null, "Dio Brando", "renanpa201518@gmail.com", "66767059072",
				TipoCliente.PESSOAFISICA, pe.encode("omundo"));
		...
		Pagamento pgto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 00:30"),
				null);
